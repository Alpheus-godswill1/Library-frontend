    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    ...
                    <div className='usefull-links'>
                        The suites Macon want to<h1>Useful Links</h1>
                    ...
                    <div className='librarian-details'>
                        <h1>Librarian</h1>
                        <p>Name: Group 8</p>
                        <p>Education: 400 Level Uniuyo Students</p>
                        <p>Contact: +23409042398232</p>
                    </div>
                </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2025 copyright all right reserved<br /><span>Group 8 UNIUYO</span></p>
            </div>
        </div>
    )
}
